...
$conditions = array('GROUP BY rm.smsWayid ORDER BY doctor_converted DESC LIMIT 1');
$topper = man_power::bmViewStatus3($conditions);
...
<div id="page-wrapper" style="background-image: url('images/screen2.jpg'); margin: 0px 0 0 0px; background-repeat:repeat-y; background-size:100%">
    ...
    $dashboard = man_power::bmViewStatus3($conditions);
    if (!empty($dashboard)) {
...
<!--                        <div class="col-xs-1">
                        ...
                        <div class="col-xs-12 text-right">
                            <div class="medium">
                                <label  id="lblPoint" style="color:white"><?php echo isset($dashboard->doctor_converted) ? $dashboard->doctor_converted : 0; ?>
                                </label>
                            </div>
                            <div><span style="color:white">Doctor Converted</span></div>
                        </div>
                    </div>
                </div>
            </div>
...
<!--                        <div class="col-xs-1">
                        ...
                        <div class="col-xs-12 text-right">
                            <div class="medium">
                                <label id="lblRx"  style="color:white"><?php echo isset($dashboard->device_clinic) ? $dashboard->device_clinic : 0; ?>
                                </label>
                            </div>
                            <div>
                                <span style="color:white"> Healthy Device Clinics</span></div>
                        </div>
                    </div>
                </div>
            </div>
...
<!--                        <div class="col-xs-1">
                        ...
                        <div class="col-xs-12 text-right">
                            <div class="medium">
                                <label  id="lblpending" style="color:white"><?php echo isset($dashboard->rcp_made) ? $dashboard->rcp_made : 0; ?>
                                </label>
                            </div>
                            <div><span style="color:white">RCP Made</span></div>
                        </div>
                    </div>
                </div>
            </div>
...
<!--                        <div class="col-xs-1">
                        ...
                        <div class="col-xs-12 text-right">
                            ...
                            <div>
                                <span style="color:white">Rotahaler</span></div>
                        </div>
                    </div>
                </div>
            </div>
...
<!--                        <div class="col-xs-1">
                        ...
                        <div class="col-xs-12 text-right">
                            <div class="medium">
                                <label id="lblunapprove"  style="color:white"><?php echo isset($dashboard->rcp_drive) ? $dashboard->rcp_drive : 0; ?>
                                </label>
                            </div>
                            <div>
                                <span style="color:white">RCP Drive</span></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="slider1_container" style="position: relative; margin: 0px 5px 5px 0px; float: left; top: 0px; left: 0px; width: 600px; height: 300px; overflow: hidden;">
                ...
                <div u="slides" style="cursor: move; text-align:center; position: absolute; left: 0px; top: 0px; width: 600px; height: 300px; overflow: hidden;">
                    <div>
                        ...
                        <br />
                        <div id="dv_tm1Region"  u="caption" t="FLTTR|R" style="position: absolute; left:0px; top: 120px; width: 100%;height: 10px; font-size: 36px; color: #fff; line-height: 40px;"><?php echo isset($topper->doctor_converted) ? $topper->doctor_converted : '-'; ?></div>
                        <br />
                    ...
                    <div>
                        <?php
                        $conditions = array('GROUP BY rm.smsWayid ORDER BY device_clinic DESC LIMIT 1');
                        $checkPointTopper = man_power::bmViewStatus3($conditions);
                        if (!empty($checkPointTopper)) {
                            $checkPointTopper = array_shift($checkPointTopper);
                        }
                        ?>
                        <img u="image" src="Images/darkback.jpg" />
                        <div id="Div1"  style="position: absolute; top: 10px;width: 100%; height: 20px; font-size: 23px; color: #fff; line-height: 30px;">Most No. Of Health Device Clinic</div>
                        ...
                        <br />
                        <div id="dv_tm2Region"  u="caption" t="ZMF|10" style="position: absolute; left:0px;top: 120px; width: 100%; height: 40px; font-size: 36px; color: #fff; line-height: 40px;"><?php echo isset($checkPointTopper->device_clinic) ? $checkPointTopper->device_clinic : '-'; ?></div>
                        <br />
                    ...
                    <div>
                        ...
                        $RotahalerTopper = man_power::bmViewStatus3($conditions);
                    ...
                    <div>
                        <?php
                        $conditions = array('GROUP BY rm.smsWayid ORDER BY rcp_drive DESC LIMIT 1');
                        $RotahalerTopper = man_power::bmViewStatus3($conditions);
                        if (!empty($RotahalerTopper)) {
                            $RotahalerTopper = array_shift($RotahalerTopper);
                        }
                        ?>
                        <img u="image" src="Images/darkback.jpg" />
                        <div id="Div2"  style="position: absolute;  top: 10px;width: 100%; height: 20px; font-size: 23px; color: #fff; line-height: 30px;">Most No. Of RCP Drive</div>
                        <div id="dv_tm3name"  u="caption" t="RTT|10" style="position: absolute;left:0px;  top: 70px; width: 100%; height: 40px; font-size: 43px; color: #fff; line-height: 40px;"><?php echo isset($RotahalerTopper->BM_Name) ? $RotahalerTopper->BM_Name : 'NA'; ?></div>
                        <br />
                        <div id="dv_tm3Region"  u="caption" t="RTT|10" style="position: absolute;left:0px; top: 120px; width: 100%; height: 40px; font-size: 36px; color: #fff; line-height: 40px;"><?php echo isset($RotahalerTopper->rcp_drive) ? $RotahalerTopper->rcp_drive : 'NA'; ?></div>
                        <br />
                        <div id="dv_tm3Rx"  u="caption" t="RTT|10" style="position: absolute;left:0px;top: 170px; width: 100%; height: 20px; font-size: 36px;font-weight:600; color:#fff; line-height: 40px;"><?php echo isset($RotahalerTopper->Region) ? $RotahalerTopper->Region : 'NA'; ?></div>
                    </div>
                </div>
